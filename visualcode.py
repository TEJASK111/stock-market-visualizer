...
#about section
    ...
    st.error("this app is made with python using streamlit (a web server based python library), as a backend to help us run it on the web server. this app is also hosted on the app under this link ""https://stockvisuals.streamlit.app/" )   
